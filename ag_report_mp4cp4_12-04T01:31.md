# AG Report MP4CP4 2023-12-04T01:31:49-06:00 
Report generated at 2023-12-04T01:39:30-06:00, using commit ``83d59c97d4f08835cf1cdc22daab6d69bfea9d8d``

Autograder Run ID: f22bb547-4693-4524-a065-bbf48f44dd8d

Autograder Job ID: d235f0b4-b45a-45ba-9cf5-726ad03ec134
...
|--:|--:|--:|
|IPC|0.2522||
|f<sub>Max</sub>|285.71|MHz|
|Power|3.3583|mW|
|Delay|10140224000|ps|
|PD<sup>2</sup>|345.31||
|PD<sup>3</sup>|3501.52||
...
cd sim && vcs /tmp/dut/pkg/types.sv /tmp/dut/hdl/cache/prefetcher.sv /tmp/dut/hdl/cache/ff_array.sv /tmp/dut/hdl/cache/cache_datapath.sv /tmp/dut/hdl/cache/cache_control.sv /tmp/dut/hdl/cache/cache.sv /tmp/dut/hdl/cache/arbiter.sv /tmp/dut/hdl/branch_predict/gshare_branch_predictor.sv /tmp/dut/hdl/branch_predict/top_predictor.sv /tmp/dut/hdl/branch_predict/local_branch_predict.sv /tmp/dut/hdl/branch_predict/global_branch_predict.sv /tmp/dut/hdl/branch_predict/btb_4way.sv /tmp/dut/hdl/branch_predict/branch_target_buffer.sv /tmp/dut/hdl/performance_counter.sv /tmp/dut/hdl/mp4.sv /tmp/dut/hdl/cacheline_adaptor.sv /tmp/dut/hdl/bus_adapter.sv /tmp/dut/hdl/cpu/utils_reg.sv /tmp/dut/hdl/cpu/utils_ex.sv /tmp/dut/hdl/cpu/pipeline_reg.sv /tmp/dut/hdl/cpu/hazard_ctrl.sv /tmp/dut/hdl/cpu/forwarding.sv /tmp/dut/hdl/cpu/datapath.sv /tmp/dut/hdl/cpu/ctrl_word.sv /tmp/dut/hvl/top_tb.sv /tmp/dut/hvl/rvfimon.v /tmp/dut/hvl/monitor.sv /tmp/dut/hvl/mon_itf.sv /tmp/dut/hvl/burst_memory.sv /tmp/dut/hvl/bmem_itf.sv /tmp/dut/sram/output/mp3_data_array/mp3_data_array.v /tmp/dut/sram/output/mp3_tag_array_2/mp3_tag_array_2.v /tmp/dut/sram/output/mp3_tag_array/mp3_tag_array.v /tmp/dut/sram/output/mp3_data_array_2/mp3_data_array_2.v -full64 -lca -sverilog +lint=all,noNS -timescale=1ns/1ns -debug_acc+all -kdb -fsdb -suppress=LCA_FEATURES_ENABLED -licqueue -msg_config=../vcs_warn.config -l compile.log -top top_tb -o top_tb
                         Chronologic VCS (TM)
      Version R-2020.12-SP1-1_Full64 -- Mon Dec  4 01:42:17 2023
...
Warning:  /tmp/dut/synth/../pkg/types.sv:230: Parameter keyword used in local parameter declaration. (VER-329)
...
Information: Building the design 'cache' instantiated from design 'mp4' with
	the parameters "s_word=256,s_mask=32,s_index=4,level=1". (HDL-193)
Presto compilation completed successfully. (cache_s_word256_s_mask32_s_index4_level1)
...
Inferred memory devices in process
	in routine cache_control line 63 in file
		'/tmp/dut/synth/../hdl/cache/cache_control.sv'.
===============================================================================
|    Register Name    |   Type    | Width | Bus | MB | AR | AS | SR | SS | ST |
===============================================================================
...
Information: Building the design 'cache_datapath' instantiated from design 'cache_s_word256_s_mask32_s_index4_level1' with
	the parameters "s_word=256,s_index=4,level=1". (HDL-193)
Presto compilation completed successfully. (cache_datapath_s_word256_s_index4_level1)
...
Information: Building the design 'ff_array' instantiated from design 'cache_datapath_s_word256_s_index4_level1' with
...
Information: Uniquified 2 instances of design 'cache_s_word256_s_mask32_s_index4_level1'. (OPT-1056)
...
Information: Uniquified 2 instances of design 'cache_datapath_s_word256_s_index4_level1'. (OPT-1056)
Information: Uniquified 2 instances of design 'CacheCounter'. (OPT-1056)
Information: Uniquified 4 instances of design 'ff_array_s_index4'. (OPT-1056)
...
Information: Ungrouping 131 of 209 hierarchies before Pass 1 (OPT-775)
...
Information: Added key list 'DesignWare' to design 'local_branch_predictor_no_bht'. (DDB-72)
 ...
 Implement Synthetic for 'branch_predictor_branch_only'.
  ...
  Processing 'SNPS_CLOCK_GATE_HIGH_ff_array_s_index4_2'
  Mapping integrated clock gating circuitry
  Processing 'SNPS_CLOCK_GATE_HIGH_ff_array_s_index4_0'
  Mapping integrated clock gating circuitry
  ...
  Mapping integrated clock gating circuitry
  Processing 'SNPS_CLOCK_GATE_HIGH_register_12_0'
  Mapping integrated clock gating circuitry
...
Information: Complementing port 'ipmem_read' in design 'arbiter_s_word256'.
	 The new name of the port is 'ipmem_read_BAR'. (OPT-319)
Information: Complementing port 'dpmem_read' in design 'arbiter_s_word256'.
	 The new name of the port is 'dpmem_read_BAR'. (OPT-319)
Information: Complementing port 'dpmem_write' in design 'arbiter_s_word256'.
	 The new name of the port is 'dpmem_write_BAR'. (OPT-319)
Information: Complementing port 'S7' in design 'local_branch_predictor_no_bht_MUX_OP_256_8_2_2'.
	 The new name of the port is 'S7_BAR'. (OPT-319)
...
Information: Added key list 'DesignWare' to design 'branch_predictor_branch_only'. (DDB-72)
  ...
  --------- --------- --------- --------- --------- ------------------------- --------- -----------
    0:00:58   57094.3      0.74     199.5    2425.8                           1131825.6250      0.00  
    0:00:58   57080.7      0.85     201.1    2422.4                           1131510.3750      0.00  

  Beginning Constant Register Removal
  -----------------------------------
    0:01:00   57228.6      0.77     199.7    2422.4                           1139313.0000      0.00  
    0:01:01   57226.5      0.77     199.7    2422.4                           1139263.8750      0.00  
  ...
  Mapping 'mp4_DP_OP_337J1_122_1193_0'
  ...
  ----------------------------
    0:01:07   45622.3      0.80      10.4    1865.7                           546303.2500      0.00  
    0:01:09   45848.6      0.00       0.0    1857.3                           554920.9375      0.00  
    0:01:09   45848.6      0.00       0.0    1857.3                           554920.9375      0.00  
    0:01:09   45834.5      0.00       0.0    1936.2                           555179.2500      0.00  
    0:01:11   45827.6      0.00       0.0    1936.2                           555023.6250      0.00  
    0:01:12   45630.5      0.00       0.0    1935.2                           549955.6250      0.00  

  Beginning WLM Backend Optimization
  --------------------------------------
    0:01:17   45116.3      0.00       0.0    1840.7                           527625.3750      0.00  
    0:01:17   45116.3      0.00       0.0    1840.7                           527625.3750      0.00  
    0:01:17   45116.3      0.00       0.0    1840.7                           527625.3750      0.00  
    0:01:19   44588.6      0.00       0.0    1601.0                           491440.4688      0.00  
    0:01:19   44588.6      0.00       0.0    1601.0                           491440.4688      0.00  
    0:01:19   44588.6      0.00       0.0    1601.0                           491440.4688      0.00  
    0:01:19   44588.6      0.00       0.0    1601.0                           491440.4688      0.00  
    0:01:19   44588.6      0.00       0.0    1601.0                           491440.4688      0.00  
  ...
  Global Optimization (Phase 34)
    0:01:19   44898.7      0.00       0.0     872.7                           497786.1250      0.00  
    0:01:19   44898.7      0.00       0.0     872.7                           497786.1250      0.00  
...
Information: Complementing port 'dpmem_read_BAR' in design 'arbiter_s_word256'.
	 The new name of the port is 'dpmem_read'. (OPT-319)
    0:01:22   44734.1      0.00       0.0     693.1                           489502.0625      0.00  
    0:01:22   44734.1      0.00       0.0     693.1                           489502.0625      0.00  
    0:01:22   44734.1      0.00       0.0     693.1                           489502.0625      0.00  
    0:01:23   44733.3      0.00       0.0     693.1                           489319.2188      0.00  
    0:01:23   44733.3      0.00       0.0     693.1                           489319.2188      0.00  
    0:01:23   44733.3      0.00       0.0     693.1                           489319.2188      0.00  
    0:01:23   44733.3      0.00       0.0     693.1                           489319.2188      0.00  
    0:01:23   44733.3      0.00       0.0     693.1                           489319.2188      0.00  
   ...
   ELAPSED            WORST NEG   SETUP    DESIGN                              LEAKAGE   MIN DELAY 
    TIME      AREA      SLACK     COST    RULE COST         ENDPOINT            POWER      COST    
  --------- --------- --------- --------- --------- ------------------------- --------- -----------
    0:01:23   44613.6      0.00       0.0     693.1                           487545.0938      0.00  
    0:01:24   44588.6      0.00       0.0     696.2                           486515.1562      0.00  
    0:01:24   44588.6      0.00       0.0     696.2                           486515.1562      0.00  
    0:01:24   44588.6      0.00       0.0     696.2                           486515.1562      0.00  
    0:01:25   44588.6      0.00       0.0     696.2                           486495.0312      0.00  
    0:01:26   44768.4      0.00       0.0     428.1                           490558.4062      0.00  
    0:01:26   44768.4      0.00       0.0     428.1                           490558.4062      0.00  
    0:01:26   44768.4      0.00       0.0     428.1                           490558.4062      0.00  
    0:01:26   44768.4      0.00       0.0     428.1                           490558.4062      0.00  
    0:01:26   44768.4      0.00       0.0     428.1                           490558.4062      0.00  
    0:01:26   44768.4      0.00       0.0     428.1                           490558.4062      0.00  
    0:01:28   44767.9      0.00       0.0     428.1                           490564.1875      0.00  
Loading db file '/srv/ece411ag/freepdk-45nm/stdcells.db'
Loading db file '/tmp/dut/sram/output/mp3_data_array/mp3_data_array_TT_1p0V_25C_lib.db'
Loading db file '/tmp/dut/sram/output/mp3_tag_array_2/mp3_tag_array_2_TT_1p0V_25C_lib.db'
Loading db file '/tmp/dut/sram/output/mp3_tag_array/mp3_tag_array_TT_1p0V_25C_lib.db'
...
Compiler version R-2020.12-SP1-1_Full64; Runtime version R-2020.12-SP1-1_Full64;  Dec  4 01:44 2023
...
Monitor: Start time is            225824000
Monitor: Stop time is          10366048000
Monitor: Segment IPC: 0.252151
Monitor: Segment Time:          10140224000
$finish called from file "/tmp/dut/hvl/top_tb.sv", line 65.
$finish at simulation time          10385753000
           V C S   S i m u l a t i o n   R e p o r t 
Time: 10385753000 ps
CPU Time:    302.630 seconds;       Data structure size:   0.3Mb
Mon Dec  4 01:47:37 2023
...
Loaded 47 designs.
Current design is 'mp4'.
mp4 regfile arbiter_s_word256 branch_predictor_branch_only SNPS_CLOCK_GATE_HIGH_register_40000000 SNPS_CLOCK_GATE_HIGH_cacheline_adaptor_s_word256_1 SNPS_CLOCK_GATE_HIGH_cacheline_adaptor_s_word256_0 SNPS_CLOCK_GATE_HIGH_register_12_4 SNPS_CLOCK_GATE_HIGH_register_12_3 SNPS_CLOCK_GATE_HIGH_register_3_5 SNPS_CLOCK_GATE_HIGH_register_12_1 SNPS_CLOCK_GATE_HIGH_register_3_2 SNPS_CLOCK_GATE_HIGH_ff_array_s_index4_0 SNPS_CLOCK_GATE_HIGH_ff_array_s_index4_1_0 SNPS_CLOCK_GATE_HIGH_mp4_2 SNPS_CLOCK_GATE_HIGH_regfile_31 SNPS_CLOCK_GATE_HIGH_regfile_30 SNPS_CLOCK_GATE_HIGH_regfile_29 SNPS_CLOCK_GATE_HIGH_regfile_28 SNPS_CLOCK_GATE_HIGH_regfile_27 SNPS_CLOCK_GATE_HIGH_regfile_26 SNPS_CLOCK_GATE_HIGH_regfile_25 SNPS_CLOCK_GATE_HIGH_regfile_24 SNPS_CLOCK_GATE_HIGH_regfile_23 SNPS_CLOCK_GATE_HIGH_regfile_22 SNPS_CLOCK_GATE_HIGH_regfile_21 SNPS_CLOCK_GATE_HIGH_regfile_20 SNPS_CLOCK_GATE_HIGH_regfile_19 SNPS_CLOCK_GATE_HIGH_regfile_18 SNPS_CLOCK_GATE_HIGH_regfile_17 SNPS_CLOCK_GATE_HIGH_regfile_16 SNPS_CLOCK_GATE_HIGH_regfile_15 SNPS_CLOCK_GATE_HIGH_regfile_14 SNPS_CLOCK_GATE_HIGH_regfile_13 SNPS_CLOCK_GATE_HIGH_regfile_12 SNPS_CLOCK_GATE_HIGH_regfile_11 SNPS_CLOCK_GATE_HIGH_regfile_10 SNPS_CLOCK_GATE_HIGH_regfile_9 SNPS_CLOCK_GATE_HIGH_regfile_8 SNPS_CLOCK_GATE_HIGH_regfile_7 SNPS_CLOCK_GATE_HIGH_regfile_6 SNPS_CLOCK_GATE_HIGH_regfile_5 SNPS_CLOCK_GATE_HIGH_regfile_4 SNPS_CLOCK_GATE_HIGH_regfile_3 SNPS_CLOCK_GATE_HIGH_regfile_2 SNPS_CLOCK_GATE_HIGH_regfile_1 SNPS_CLOCK_GATE_HIGH_local_branch_predictor_no_bht
read_saif -input ../sim/dump.fsdb.saif -instance top_tb/dut
Warning: There are 33463 objects not found during annotation. (PWR-452)
1
...
Warning: There are 2 switching activity information conflicts. (PWR-19)
...
branch_predictor_branch_only
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_register_40000000
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_cacheline_adaptor_s_word256_1
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_cacheline_adaptor_s_word256_0
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_register_12_4
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_register_12_3
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_register_3_5
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_register_12_1
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_register_3_2
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_ff_array_s_index4_0
                       5K_hvratio_1_1    NangateOpenCellLibrary
...
SNPS_CLOCK_GATE_HIGH_regfile_1
                       5K_hvratio_1_1    NangateOpenCellLibrary
SNPS_CLOCK_GATE_HIGH_local_branch_predictor_no_bht
                       5K_hvratio_1_1    NangateOpenCellLibrary
...
Power-specific unit information :
  ...
  Cell Internal Power  =   2.5165 mW   (88%)
  Net Switching Power  = 343.6158 uW   (12%)
                         ---------
Total Dynamic Power    =   2.8601 mW  (100%)

Cell Leakage Power     = 498.1551 uW
...
memory         1.5861e+03            4.0711        1.0350e+04        1.6005e+03  (  47.66%)
black_box          0.0000            0.0000            0.0000            0.0000  (   0.00%)
clock_network     81.8239          229.1802        2.6080e+03          313.6121  (   9.34%)
register         795.2050           16.7319        2.4370e+05        1.0556e+03  (  31.43%)
sequential         0.0000            0.0000            0.0000            0.0000  (   0.00%)
combinational     53.3804           93.6325        2.4150e+05          388.5102  (  11.57%)
--------------------------------------------------------------------------------------------------
Total          2.5165e+03 uW       343.6157 uW     4.9816e+05 nW     3.3583e+03 uW
1
exit
